...
export const MovieCard = ({ movie }: Props) => {
  ...
  return (
    <Card className="group overflow-hidden transition-all duration-300 shadow-sm hover:shadow-lg dark:hover:shadow-primary/10 border-muted/50">
      <div className="relative w-full h-80 bg-muted/30 overflow-hidden">
        {hasImage ? (
          ...
          <div className="flex flex-col items-center justify-center w-full h-full gap-2 p-4 text-muted-foreground bg-secondary/20">
            <Clapperboard className="w-12 h-12 opacity-20" strokeWidth={1.5} />
